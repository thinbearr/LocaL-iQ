...
* **Gemini-Powered Generation**: Leverages Google Gemini (`gemini-3.6-flash`) for precise, grounded synthesis.
...
### LLM Generation
* **Google Gemini**: `google-genai` SDK using `gemini-3.6-flash` as the sole generation model.
